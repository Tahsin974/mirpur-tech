...
import banner from "../../assets/contact/contact-us.png";
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center text-center px-4 py-24 md:py-32 lg:py-40">
          <div>
            ...
            >
              We’re here to help you anytime. Reach out for support, inquiries,
              or business collaboration. Our team will respond as quickly as
              possible.
            </motion.p>
          </div>
        </div>
